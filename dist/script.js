...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_7__["default"])(); // TODO: уменьшить количество переменных для селекторов, рефакторить повторяющиеся добавления обработчиков событий 

  Object(_modules_pictureSize__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_9__["default"])('.accordion-heading'); // TODO: Сделать открытие аккордеона только одного элемента, остальным автозакрытие 
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  if (menu.style.display =  true && window.screen.availWidth <= 992) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = 'Выберите материал и размер картины';
...
var forms = function forms(state) {
  ...
  var uploads = document.querySelectorAll('[name="upload"]'); // checkForNum('input[name="user_phone"]')
...
var pictureSize = function pictureSize(selectors) {
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: getResources, postData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
